    ...
    def control(self,lists):
        try:
            ...
            for i in lists:
                ...
                j=j+1
                if j>=5:
                    tsk = [threading.Thread(target=self.run,args=(self.list_browser[k['signal']],k['url'])) for k in list_text] 
